...
<div>
    ...
    <section id="myServices">
        ...
        <div className="div3">
            ...
            <p>A website that interacts with the user by dynamically rewriting the current web page with new data from
                the
                web
    ...
    <section id="myProcess">
        ...
        <div className="div1">
            ...
            <p>I define your goals and make schedule for the project. I then make requirement for documents, wireframe
                of
                pages and sitemap.</p>
        </div>
        ...
        <div className="div3">
            ...
            <h4>Testing</h4>
            <p>When the build is finalized I will need to test it to make sure that everything is working correctly.
                <br />I
        ...
        <div className="div4">
            ...
            <p>Once both parties are happy, website is then unveiled to the awaiting public. Upon request, I keep up to
                date
    ...
    <section id="featuredWork">
        ...
        <div className="div1">
            <div className="project">
                <a target='blank' href='https://mara-river-capital-redesign.vercel.app'>
                    <Element1 /></a>
            </div>
        ...
        <div className="div2">
            <div className="project">
                <a target='blank' href='https://piotrbania.dev/'>
                    <Element2 /></a>
            </div>
        ...
        <div className="div3">
            <div className="project">
                <a target='blank' href='http://retirement-center.space/'>
                    <Element3 /></a>
            </div>
    ...
    <section id="quote">
        ...
        <h2 className='quote'>Ready to make your <abbr className='purple'>idea </abbr>come to <abbr
                className='magenta'>life
            </abbr>?</h2>
    ...
    <section id="about">
        ...
        <div className="description upper">
            ...
            <p>I am a self-taught web developer from Poland.
                ...
                environments and UI. I translate designs to front-end code and easily work with cross-functional teams
                to define
                and develop any product roadmaps.
                <br /><br />
                I am based in London, UK.
                <br />
                I am experienced with HTML5, CSS3, JavaScript, Node.js, React.js, Next.js. I also have +7 years of
                experience
                with WordPress.
                <br /><br />
        ...
        <div className="description lower">
            ...
            <p>Bespoke Programming is a Private Limited Company incorporated in United Kingdom on 6th of June 2022.
                <br /><br />
                It was
                created in order to help local companies with their growth, through a medium of web presence and search
                engine
                optimization.
                <br /><br />
